...
import { signInWithEmailPassword100Service } from '../SignInWithEmailPassword100Service';
...
export class AuthorizationClient {
  ...
  public configure(configs: AuthorizationConfigs) {
    return new Promise<void>((resolve) => {
      ...
      // Configure the authApiClient and signInWithEmailPassword100Service with the provided configs
      authApiClient.configure(configs);
      signInWithEmailPassword100Service.configure(configs);
      resolve();
    });
  }
